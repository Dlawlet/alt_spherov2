...
class BOLT(ToyV2):
    ...
    remove_robot_to_robot_infrared_message_received_notify_listener = partialmethod(Toy._remove_listener,
                                                                                    Sensor.robot_to_robot_infrared_message_received_notify)  # RobotToRobotInfraredMessageReceivedNotifyCommand
    send_robot_to_robot_infrared_message = partialmethod(Sensor.send_robot_to_robot_infrared_message, proc=Processors.SECONDARY)  # SendRobotToRobotInfraredMessageCommand
    ...
    #stop_robot_to_robot_infrared_following = partialmethod(Sensor.stop_robot_to_robot_infrared_following, proc=Processors.SECONDARY)  # StartRobotToRobotInfraredFollowingCommand
