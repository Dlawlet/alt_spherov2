...
class SpheroEduAPI:
    ...
    def getatt(self, name):# add by me to get the attribute
        if name == 'heading':
            ...
            return self.__falling_v
        elif name == 'lastLocation':
            return self.__last_location
        elif name == 'shouldLand':
            return self.__should_land
        elif name == 'freeFalling':
            return self.__free_falling
        elif name == 'listeners':
    ...
    def _collision_detected_notify(self): # args have been removed cause they are not used
