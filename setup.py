...
setup(
    name='alt_spherov2',
    version='0.11.4',
    author='Hanbang Wang', # and 'Elionardo Feliciano', # momentaneous alt version by Dlawlet
    ...
    url='https://github.com/Dlawlet/alt_spherov2',
    ...
    python_requires='>=3.7',
    install_requires=['numpy', 'transforms3d', 'bleak']
)
