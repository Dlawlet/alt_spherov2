...
class SpheroBolt():
    ...
    def __init__(self) -> None:
        ...
        self.led_front_rgb  = Color(0, 0, 0)
        self.led_back_rgb   = Color(0, 0, 0)
        self.led_main_rgb   = Color(0, 0, 255)
    ...
    def create_ros_subscribers(self) -> None:
        ...
        # Main LED 
        rospy.Subscriber('sphero/led_main_rgb', ColorRGBA,
                         self.led_main_rgb_callback, queue_size=1)
    ...
    def led_main_rgb_callback(self, msg) -> None:
        self.led_main_rgb = Color(round(msg.r), round(msg.g), round(msg.b))
    ...
    def create_ros_publishers(self) -> None:
        ...
        # Acceleration
        self.pub_acceleration = rospy.Publisher('sphero/acceleration',
                                               Imu, queue_size=1)
    ...
    def publish_acceleration(self):
        vector3_msg = Vector3()
        vector3_msg.x , vector3_msg.y, vector3_msg.z = droid.get_acceleration()['x'], droid.get_acceleration()['y'], droid.get_acceleration()['z']
        acceleration_msg = Imu()
        acceleration_msg.linear_acceleration = vector3_msg
...
def set_sphero_leds(self):
        ...
        if droid.get_main_led != self.led_main_rgb:
            droid.set_main_led(self.led_main_rgb)
            if self.led_main_rgb == Color(255,0,0):
    ...
    def start_follow(self):
        try:
            ...
            pass
        droid.start_ir_follow(4,5)

    def start_collision_detection(self):
        droid.register_event(EventType.on_collision, self.onCollision)
